...
--
-- Δομή πίνακα για τον πίνακα `ea_writers_providers`
--

CREATE TABLE IF NOT EXISTS `ea_writers_providers` (
  `id_users_writer` bigint(20) unsigned NOT NULL,
  `id_users_provider` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id_users_writer`,`id_users_provider`),
  KEY `fk_ea_writers_providers_1` (`id_users_writer`),
  KEY `fk_ea_writers_providers_2` (`id_users_provider`)
...
--
-- Περιορισμοί για πίνακα `ea_writers_providers`
--
ALTER TABLE `ea_writers_providers`
  ADD CONSTRAINT `fk_ea_writers_providers_1` FOREIGN KEY (`id_users_writer`) REFERENCES `ea_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ea_writers_providers_2` FOREIGN KEY (`id_users_provider`) REFERENCES `ea_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
(4, 'writer', 'writer', 0, 15, 15, 0, 0, 0, 15);
