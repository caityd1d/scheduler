...
$lang['writer_saved'] = 'Ο γραμματέας αποθηκεύτηκε επιτυχώς!';
$lang['admin_deleted'] = 'Ο διαχειριστής διαγράφηκε επιτυχώς!';
$lang['provider_deleted'] = 'Ο πάροχος διαγράφηκε επιτυχώς!';
$lang['writer_deleted'] = 'Ο γραμματέας διαγράφηκε επιτυχώς!';
...
$lang['delete_writer'] = 'Διαγραφή Γραμματέα';
