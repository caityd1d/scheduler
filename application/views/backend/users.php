...
<script type="text/javascript" 
        src="<?php echo $base_url; ?>assets/js/backend_users_writers.js"></script>
...
<script type="text/javascript">    
    var GlobalVariables = {
        ...
        'writers': <?php echo json_encode($writers); ?>,
...
<div id="users-page" class="row-fluid">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="writers-tab tab"><a><?php echo $this->lang->line('writers'); ?></a></li>
    </ul>
    ...
    <?php 
        ...
        // ---------------------------------------------------------------------
    ?>
    <div id="writers" class="tab-content" style="display:none;">
        <div id="filter-writers" class="filter-records column span4">
            <form class="input-append">
                <input class="key span12" type="text" />
                <button class="filter btn" type="submit" title="<?php echo $this->lang->line('filter');?>">
                    <i class="icon-search"></i>
        ...
        <div class="details column span7">
            <div class="btn-toolbar">
                <div class="add-edit-delete-group btn-group">
                    <button id="add-writer" class="btn btn-primary">
                        <i class="icon-plus icon-white"></i>
                        <?php echo $this->lang->line('add');?>
                    </button>
                    <button id="edit-writer" class="btn" disabled="disabled">
                        <i class="icon-pencil"></i>
                        <?php echo $this->lang->line('edit');?>
                    </button>
                    <button id="delete-writer" class="btn" disabled="disabled">
                        <i class="icon-remove"></i>
                        <?php echo $this->lang->line('delete');?>
                    </button>
                </div>
                ...
                <div class="save-cancel-group btn-group" style="display:none;">
                    <button id="save-writer" class="btn btn-primary">
                        <i class="icon-ok icon-white"></i>
                        <?php echo $this->lang->line('save');?>
                    </button>
                    <button id="cancel-writer" class="btn">
                        <i class="icon-ban-circle"></i>
                        <?php echo $this->lang->line('cancel');?>
                    </button>
                </div>
            ...
            <input type="hidden" id="writer-id" class="record-id" />
            
            <div class="row-fluid">
                <div class="writer-details span6">
                    <label for="writer-first-name"><?php echo $this->lang->line('first_name');?> *</label>
                    <input type="text" id="writer-first-name" class="span11 required" />

                    <label for="writer-last-name"><?php echo $this->lang->line('last_name');?> *</label>
                    <input type="text" id="writer-last-name" class="span11 required" />

                    <label for="writer-email"><?php echo $this->lang->line('email');?> *</label>
                    <input type="text" id="writer-email" class="span11 required" />

                    <label for="writer-mobile-number"><?php echo $this->lang->line('mobile_number');?></label>
                    <input type="text" id="writer-mobile-number" class="span11" />

                    <label for="writer-phone-number"><?php echo $this->lang->line('phone_number');?> *</label>
                    <input type="text" id="writer-phone-number" class="span11 required" />

                    <label for="writer-address"><?php echo $this->lang->line('address');?></label>
                    <input type="text" id="writer-address" class="span11" />

                    <label for="writer-city"><?php echo $this->lang->line('city');?></label>
                    <input type="text" id="writer-city" class="span11" />

                    <label for="writer-state"><?php echo $this->lang->line('state');?></label>
                    <input type="text" id="writer-state" class="span11" />

                    <label for="writer-zip-code"><?php echo $this->lang->line('zip_code');?></label>
                    <input type="text" id="writer-zip-code" class="span11" />

                    <label for="writer-notes"><?php echo $this->lang->line('notes');?></label>
                    <textarea id="writer-notes" class="span11" rows="3"></textarea>
                </div>
                <div class="writer-settings span6">
                    <label for="writer-username"><?php echo $this->lang->line('username');?> *</label>
                    <input type="text" id="writer-username" class="span9 required" />
                   
                    <label for="writer-password"><?php echo $this->lang->line('password');?> *</label>
                    <input type="password" id="writer-password" class="span9 required"/>
                    
                    <label for="writer-password-confirm"><?php echo $this->lang->line('retype_password');?> *</label>
                    <input type="password" id="writer-password-confirm" class="span9 required" />
                    
                    <br>
                    
                    <button type="button" id="writer-notifications" class="btn" data-toggle="button">
                        <i class="icon-envelope"></i>
                        <span><?php echo $this->lang->line('receive_notifications');?></span>
                    </button>
